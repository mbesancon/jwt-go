...
var (
	// ErrECDSAVerification missing from crypto/ecdsa compared to crypto/rsa
...
// Alg getting the 'alg' key and implements the Alg method
...
func (m *SigningMethodECDSA) Sign(signingString string, key interface{}) (string, error) {
	...
	if m.CurveBits != curveBits {
		return "", ErrInvalidKey{key: ecdsaKey}
	}
